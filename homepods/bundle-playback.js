        ...
        wombat: function(e, t, n, o, r, a) {
            var c = "".concat(n).concat(o, "/"),
                ...
                u = {
                    ...
                    wombat_host: l.host,
                    wombat_opts: {
                        no_rewrite_prefixes: ["/__wb/", r, "".concat(n).concat(r.substring(1)), "/web/", c, "http://analytics.archive.org/", "https://analytics.archive.org/", "//analytics.archive.org/"]
                    }
                };
            if ("undefined" != typeof _WBWombat) {
                ...
                return _WBWombat.prototype.rewriteUrl = function(e) {
                    ...
                    return s ? h.call.apply(h, [this, e].concat(n)) : e
