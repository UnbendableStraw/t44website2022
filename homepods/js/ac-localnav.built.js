        ...
        55: [function(t, e, i) {
            ...
            var n = t("@marcom/ac-localnav/Localnav"),
                ...
                o = function(t) {
                    ...
                    }), this._updateComingSoonSubheadClasses(), this._sticky && (this._analyticsRegion = this.el.getAttribute("data-analytics-region"), this._updateAnalyticsRegion = this._updateAnalyticsRegion.bind(this), this._sticky.on("stuck", this._updateAnalyticsRegion), this._sticky.on("unstuck", this._updateAnalyticsRegion))
                },
                c = n.prototype,
            ...
            o.prototype.constructor = o, h._getStickyEnabled = function() {
                ...
                t && !this.el.classList.contains("ac-localnav-stacked") && this.el.classList.add("ac-localnav-stacked")
            }, e.exports = o
        }, {
