...
if (!self.__WB_pmw) {
    ...
    require = function() {
        ...
        3: [function(t, e, r) {
            ...
            "@marcom/ac-prefixer/getStyleProperty": 15,
            "@marcom/ac-prefixer/getStyleValue": 16
        }],
        4: [function(t, e, r) {
            "use strict";
            e.exports = {
        ...
        14: [function(t, e, r) {
            ...
            "@marcom/ac-feature/touchAvailable": 7
        }],
        15: [function(t, e, r) {
            "use strict";
        ...
        33: [function(t, e, r) {
            ...
            function l(t, e) {
                t._state === S && (t._state = E, t._detail = e, d.async(p, t))
            }

            function f(t, e) {
                t._state === S && (t._state = E, t._detail = e, d.async(m, t))
            }
        ...
        41: [function(t, e, r) {
            ...
            var o = t("@marcom/ac-headjs"),
                n = t("@marcom/ac-feature/isTablet"),
                i = t("@marcom/ac-css-mask/featureDetectTest"),
                a = t("./shared/model/animatedHeroAvailable"),
                s = t("./shared/model/positionStickyAvailable"),
                c = t("./shared/model/prefersReducedMotion"),
                u = t("./shared/model/roomVideoSupported"),
                l = t("@marcom/ac-useragent"),
                f = document.documentElement.classList.contains("aow"),
                p = function() {
                    return {
                        initialize: function() {
                            return o.addTests({
                                "reduced-motion": c || f,
                                "hero-animated": a,
                                "copy-parallax": !c && !(l.browser.ie || l.browser.android) && !f,
                                ...
                                ie: l.browser.ie,
                                edge: l.browser.edge
                            }), o.addTests(i), o.htmlClass(), this._setupWindowListeners(), this
                        },
                        _onWindowLoad: function() {
                            var t = !c && !f && window.innerWidth > 735;
                            o.addTests({
                                "copy-engagement": t
                            }), o.htmlClass(), window.removeEventListener("load", this._onWindowLoad)
                        },
                        _setupWindowListeners: function() {
                            this._onWindowLoad = this._onWindowLoad.bind(this), window.addEventListener("load", this._onWindowLoad)
                        }
                    }
                }();
            e.exports = p.initialize()
        }, {
            "./shared/model/animatedHeroAvailable": 42,
            "./shared/model/positionStickyAvailable": 43,
            "./shared/model/prefersReducedMotion": 44,
            "./shared/model/roomVideoSupported": 45,
            "@marcom/ac-css-mask/featureDetectTest": 2,
            "@marcom/ac-feature/isTablet": 6,
            "@marcom/ac-headjs": 13,
            "@marcom/ac-polyfills": "@marcom/ac-polyfills",
            "@marcom/ac-useragent": 23
        }],
        42: [function(t, e, r) {
            "use strict";
            e.exports = function() {
                var e = t("@marcom/ac-useragent"),
                    r = t("./positionStickyAvailable"),
                    o = t("./prefersReducedMotion"),
                    n = document.documentElement.classList.contains("aow"),
                    i = [!e.os.android, !e.browser.edge, r, !o, !n];
                return i.indexOf(!1) === -1
            }
        }, {
            "./positionStickyAvailable": 43,
            "./prefersReducedMotion": 44,
            "@marcom/ac-useragent": 23
        }],
        43: [function(t, e, r) {
            "use strict";
            var o = t("@marcom/ac-feature/cssPropertyAvailable");
            e.exports = o("position", "sticky")
        }, {
            "@marcom/ac-feature/cssPropertyAvailable": 3
        }],
        44: [function(t, e, r) {
            "use strict";
            e.exports = window.matchMedia("(prefers-reduced-motion)").matches
        }, {}],
        45: [function(t, e, r) {
            "use strict";
            e.exports = function() {
                var e = t("@marcom/ac-useragent"),
                    ...
                    o = document.documentElement.classList.contains("aow"),
                    n = e.os.ios && e.os.version.major >= 9,
                    i = [r() || n, !o];
                return i.indexOf(!1) === -1
            }
        }, {
            "@marcom/ac-feature/isDesktop": 5,
            "@marcom/ac-useragent": 23
        }],
